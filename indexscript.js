        ...
        if (which_page == "main"){
            ...
            if (attendancemode){
                ...
                if (addfacemode){
                    ...
                    // document.getElementById('classnumber').Fvalue = classid;
                    // document.getElementById('classnumber2').value = classid;
